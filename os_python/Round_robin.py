...
go_wait_q = multiprocessing.Value('d',0)
go_back_wait_q = multiprocessing.Value('d',0)
go_ready_q = multiprocessing.Value('d',0)
go_back_ready_q = multiprocessing.Value('d',0)
